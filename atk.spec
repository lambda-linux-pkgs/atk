...
# upstream fix
Patch0: 0001-Fix-an-off-by-one-in-role-names.patch
...
* Fri Jul 12 2013 Matthias Clasen <mclasen@redhat.com> - 2.8.0-2
- Fix an off-by-one error in role names that breaks lsb tests
